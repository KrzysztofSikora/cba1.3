    ...
    <div class="container custom-header custom-font">
        ...
        <div class="row">
            <div data-aos="zoom-in" class="col-md-12 text-center">
                <a href="#skills" class="page-scroll btn btn-primary btn-lg btn-color" role="button"
                   aria-disabled="true">UMIEJĘTNOŚCI</a>
        ...
        <div class="row">
            ...
            <div class="col-md-7 text-center">
                ...
                <p class="text-justify lead">
                    ...
                    Założyliśmy fundację <strong>Wyścig po Nadzieję</strong> i w ramach
