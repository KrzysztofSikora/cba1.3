...
use FrontSupportBundle\Form\AlbumType;
use FrontSupportBundle\Form\AlbumTypeEdit;
...
class AlbumController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $albums = $em->getRepository('FrontSupportBundle:Album')->findAll();
    ...
    {
        $album = new Album();
        $form = $this->createForm('FrontSupportBundle\Form\AlbumType', $album);
    ...
    {
        $deleteForm = $this->createDeleteForm($album);
        $editForm = $this->createForm('FrontSupportBundle\Form\AlbumTypeEdit', $album);
...
//        $entity =  new Image();
        $entity = $em->getRepository('FrontSupportBundle:Album')
