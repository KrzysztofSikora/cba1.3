...
use FrontSupportBundle\Entity\Carousel;
use FrontSupportBundle\Form\CarouselType;
use FrontSupportBundle\Form\CarouselTypeEdit;
...
class CarouselController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $carousels = $em->getRepository('FrontSupportBundle:Carousel')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('FrontSupportBundle\Form\CarouselType', $carousel);
    ...
    {
        $deleteForm = $this->createDeleteForm($carousel);
        $editForm = $this->createForm('FrontSupportBundle\Form\CarouselTypeEdit', $carousel);
