...
use FrontSupportBundle\Entity\Squad;
use FrontSupportBundle\Form\SquadType;
use FrontSupportBundle\Form\SquadTypeEdit;
...
class SquadController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $squads = $em->getRepository('FrontSupportBundle:Squad')->findAll();
    ...
    {
        $squad = new Squad();
        $form = $this->createForm('FrontSupportBundle\Form\SquadType', $squad);
    ...
    {
        $deleteForm = $this->createDeleteForm($squad);
        $editForm = $this->createForm('FrontSupportBundle\Form\SquadTypeEdit', $squad);
