...
use FrontSupportBundle\Entity\Story;
use FrontSupportBundle\Form\StoryType;
...
class StoryController extends Controller
{
    ...
    {
        $story = new Story();
        $form = $this->createForm('FrontSupportBundle\Form\StoryType', $story);
    ...
    {
        $deleteForm = $this->createDeleteForm($story);
        $editForm = $this->createForm('FrontSupportBundle\Form\StoryType', $story);
