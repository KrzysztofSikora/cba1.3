 ...
 * @ORM\Entity(repositoryClass="FrontSupportBundle\Repository\AlbumRepository")
 */
class Album
{
    /**
...
//        $l = $this->getId();
     ...
     * Add albumname
     *
     * @param \FrontSupportBundle\Entity\Image $albumname
     * @return Album
     */
    public function addAlbumname(\FrontSupportBundle\Entity\Image $albumname)
    {
        $this->albumname[] = $albumname;
     ...
     * @param \FrontSupportBundle\Entity\Image $albumname
     */
    public function removeAlbumname(\FrontSupportBundle\Entity\Image $albumname)
    {
