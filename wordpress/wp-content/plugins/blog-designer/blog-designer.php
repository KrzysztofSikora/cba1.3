    ...
    function wp_blog_designer_enqueue_color_picker($hook_suffix) {
        ...
        if (isset($_GET['page']) && ($_GET['page'] == 'designer_settings' || $_GET['page'] == 'about_blog_designer')) {
            ...
            wp_localize_script('my-script-handle', 'bdlite_js', array(
                'nothing_found' => __("Oops, nothing found!", "wp_blog_designer"),
                'reset_data' => __("Do you want to reset data?", "wp_blog_designer")
                    )
            );
    ...
    function latest_news_solwin_feed() {
        ...
        if (!function_exists('solwin_latest_news_with_product_details')) {
            ...
            function solwin_latest_news_with_product_details() {
                ...
                add_meta_box('wp_blog_designer_dashboard_widget', __('News From Solwin Infotech', 'wp_blog_designer'), 'solwin_dashboard_widget_news', 'dashboard', 'normal', 'high');
            }
        ...
        if (!function_exists('solwin_dashboard_widget_news')) {
            ...
            function solwin_dashboard_widget_news() {
                ...
                wp_widget_rss_output(array(
                    ...
                    'title' => __('News From Solwin Infotech', 'wp_blog_designer'),
                    'items' => 5,
                    'show_summary' => 0,
                    'show_author' => 0,
                    'show_date' => 1
                ...
                . '<div class="product-detail"><p><strong>' . __('Latest Product', 'wp_blog_designer') . '</strong></p>';
                $response = wp_remote_post(LATEST_PRODUCT_FILE);
                if (is_wp_error($response)) {
                    $error_message = $response->get_error_message();
                    echo "<p>" . __('Something went wrong', 'wp_blog_designer') . " : $error_message" . "</p>";
                } else {
            ...
            if (!function_exists('bd_remove_footer_admin')) {
                ...
                function bd_remove_footer_admin() {
                    ...
                    <p id="footer-left" class="alignleft">
                        ...
                        <a href="https://www.solwininfotech.com/product/wordpress-plugins/blog-designer/" target="_blank"><strong><?php _e('Blog Designer', 'wp_blog_designer'); ?></strong></a>
                        <?php _e('please leave us a', 'wp_blog_designer'); ?>
                        <a class="bdp-rating-link" data-rated="Thanks :)" target="_blank" href="https://wordpress.org/support/plugin/blog-designer/reviews?filter=5#new-post">&#x2605;&#x2605;&#x2605;&#x2605;&#x2605;</a>
    ...
    function wp_blog_designer_views() {
        ...
        if (!isset($settings['template_name']) || empty($settings['template_name'])) {
            ...
            if (is_user_logged_in()) {
                $link_message = __('plz go to ', 'wp_blog_designer') . '<a href="' . admin_url('admin.php?page=designer_settings') . '" target="_blank">' . __('Blog Designer Panel', 'wp_blog_designer') . '</a>' . __(' , select Blog Designs & save settings.', 'wp_blog_designer');
            }
            return __("You haven't created any blog designer shortcode.", 'wp_blog_designer') . ' ' . $link_message;
        }
        ...
        <div class="blog_template bdp_blog_template spektrum">
            ...
            <div class="spektrum_content_div">
                ...
                ?>">
                        ...
                        <span class="date">
                            <span class="number-date"><?php the_time(__('d')); ?></span>
                        <?php the_time(__('F')); ?>
                        </span><?php }
        ?>
                    <h1><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h1>
                ...
                <div class="post-bottom">
                    ...
                    if (get_option('display_author') == 0) {
                        ?>
                        <span class="post-by">
...
if (!function_exists('wp_evolution_template')) {
    ...
    function wp_evolution_template($alterclass) {
        ...
        <div class="blog_template bdp_blog_template evolution <?php echo $alterclass; ?>">
            ...
            <div class="post-entry-meta"><?php if (get_option('display_date') == 0) { ?>
                    <span class="date"><span class="number-date"><?php the_time(__('d')); ?></span> <?php the_time(__('F')); ?></span><?php
                }
                if (get_option('display_author') == 0) {
                    ?>
                    <span class="author"><?php _e('Posted by ', 'wp_blog_designer'); ?><a href="<?php echo get_author_posts_url(get_the_author_meta('ID')); ?>"><?php the_author(); ?></a></span><?php
                }
                if (get_option('display_comment_count') == 0) {
...
if (!function_exists('wp_timeline_template')) {
    ...
    function wp_timeline_template($alterclass) {
        ...
        <?php if (get_option('display_author') == 0) { ?>
                                    ...
                                    <?php } if (get_option('display_comment_count') == 0) { ?>
                                    <span class="metacomments">
                                        <div class="icon-comment"></div>
                                    <?php comments_popup_link(__('No Comments', 'wp_blog_designer'), __('1 Comment', 'wp_blog_designer'), __('% Comments', 'wp_blog_designer')); ?>
                                    </span>
                            ...
                            <div class="post_content">
                                ...
                                <div class="read_more">
                                    ...
                                    if (get_option('read_more_text') != '') {
                                        ...
                                        echo ' <a class="more-tag" href="' . get_permalink($post->ID) . '"><i class="fa fa-plus"></i> ' . __('Read more &raquo;', 'wp_blog_designer') . '</a>';
                                    }
                                    ?>
                                </div>
        <?php endif; ?>
                    ...
                    <footer class="blog_footer text-capitalize"><?php if (get_option('display_category') == 0) { ?>
                            <span class="categories">
    ...
    function wp_blog_designer_menu_function() {
        ...
        <div class="wrap">
            ...
            <div class="updated notice notice-success" id="message">
                ...
                <p><?php _e('Want more blog designer support for all types of archive pages, single post page and much more?', 'wp_blog_designer'); ?> <b><a href="https://codecanyon.net/item/blog-designer-pro-for-wordpress/17069678?ref=solwin" target="blank"><?php _e('Upgrade to PRO', 'wp_blog_designer'); ?></a></b></p>
            </div>
            <?php
            if (isset($_REQUEST['bdRestoreDefault']) && isset($_GET['updated']) && 'true' == esc_attr($_GET['updated'])) {
                echo '<div class="updated" ><p>' . __('Blog Designer setting restored successfully.', 'wp_blog_designer') . '</p></div>';
            } else if (isset($_GET['updated']) && 'true' == esc_attr($_GET['updated'])) {
                echo '<div class="updated" ><p>' . __('Blog Designer settings updated.', 'wp_blog_designer') . '</p></div>';
            }
            $settings = get_option("wp_blog_designer_settings");
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <div class="bdp-setting-description">
                                                                <b><?php _e('Caution:', 'wp_blog_designer'); ?></b>
                                                                <?php
                                                                _e('You are about to select the page for your blog layout, you will lose your page content that might be text and images. There is no undo. Think about it!', 'wp_blog_designer');
                                                                ?>
                                                            </div>
                                                        </td>
                                                    </tr>
        ...
        <?php _e('You can get more template selections with the pro version.', 'wp_blog_designer'); ?>
                                                            </p>
                                                        </td>
                                                    </tr>
                                    ...
                                    <div id="bdptitle" class="postbox postbox-with-fw-options <?php echo bdp_postbox_classes('bdptitle', $page); ?>">
                                        ...
                                        <h3 class="hndle ui-sortable-handle">
                                            <span>
        <?php _e('Post Title Settings', 'wp_blog_designer') ?>
                                            </span>
                                        </h3>
                                        <div class="inside">
                                            <table>
        ...
        <?php } ?>
                                    ...
                                    <div id="bdpcontent" class="postbox postbox-with-fw-options <?php echo bdp_postbox_classes('bdpcontent', $page); ?>">
                                        ...
                                        <h3 class="hndle ui-sortable-handle">
                                            <span>
        <?php _e('Post Content Settings', 'wp_blog_designer') ?>
                                            </span>
                                        </h3>
                                        <div class="inside">
                                            <table>
        ...
        <?php } ?>
                                    ...
                                    <div id="bdpsocial" class="postbox postbox-with-fw-options <?php echo bdp_postbox_classes('bdpsocial', $page); ?>">
                                        ...
                                        <h3 class="hndle ui-sortable-handle">
                                            <span>
        <?php _e('Social Share Settings', 'wp_blog_designer') ?>
                                            </span>
                                        </h3>
                                        <div class="inside">
                                            <table>
                ...
                <div class="inner">
                    <input type="submit" class="button button-primary button-large save_blogdesign" value="<?php _e('Save Changes', 'wp_blog_designer'); ?>" />
                    <input type="submit" name="bdRestoreDefault" class="button button-secondary bdp-restore-default button-large" value="<?php _e('Restore Default', 'wp_blog_designer'); ?>"/>
        ...
        <?php _e(' rate this plugin 5 stars!', 'wp_blog_designer'); ?>
                            </a>
                        </span>
                ...
                <div class="useful_plugins">
                    <h2>
        <?php _e('Blog Designer PRO', 'wp_blog_designer'); ?>
                    </h2>
                    <div class="help-wrapper">
                        <div class="pro-content">
                            <ul class="advertisementContent">
                                <li><?php _e("29 Beautiful Blog Templates", 'wp_blog_designer') ?></li>
                                <li><?php _e("5 Unique Timeline Templates", 'wp_blog_designer') ?></li>
                                <li><?php _e("5 Unique Grid Templates", 'wp_blog_designer') ?></li>
                                <li><?php _e("3 Unique Slider Templates", 'wp_blog_designer') ?></li>
                                <li><?php _e("100+ Blog Layout Variations", 'wp_blog_designer') ?></li>
                                <li><?php _e("Multiple Single Post Layout options", 'wp_blog_designer') ?></li>
                                <li><?php _e("Category, Tag, Author & Date Layouts", 'wp_blog_designer') ?></li>
                            ...
                            <p class="pricing_change">Now only at <del>$29</del> <ins>$24</ins></p>
                        </div>
                ...
                <div class="bd-support">
                    ...
                    <div class="help-wrapper">
                        <div style='display:block;margin-bottom:8px;'>
                            <a href="https://twitter.com/solwininfotech" class="twitter-follow-button" data-show-count="false" data-show-screen-name="true" data-dnt="true">Follow @solwininfotech</a>
...
if (!function_exists('bd_plugin_links')) {
    ...
    function bd_plugin_links($links) {
        $links[] = '<a target="_blank" href="' . esc_url('https://www.solwininfotech.com/documents/wordpress/blogdesigner-lite/') . '">' . __('Documentation', 'wp_blog_designer') . '</a>';
        return $links;
    }
