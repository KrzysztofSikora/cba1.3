...
use MyFrontendBundle\Entity\Tasks;
use MyFrontendBundle\Form\TasksType;
...
class TasksController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $tasks = $em->getRepository('MyFrontendBundle:Tasks')->findAll();
    ...
    {
        $task = new Tasks();
        $form = $this->createForm('MyFrontendBundle\Form\TasksType', $task);
    ...
    {
        $deleteForm = $this->createDeleteForm($task);
        $editForm = $this->createForm('MyFrontendBundle\Form\TasksType', $task);
