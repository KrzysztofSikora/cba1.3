...
use MyFrontendBundle\Entity\Story;
use MyFrontendBundle\Form\StoryType;
...
class StoryController extends Controller
{
    ...
    {
        $story = new Story();
        $form = $this->createForm('MyFrontendBundle\Form\StoryType', $story);
    ...
    {
        $deleteForm = $this->createDeleteForm($story);
        $editForm = $this->createForm('MyFrontendBundle\Form\StoryType', $story);
